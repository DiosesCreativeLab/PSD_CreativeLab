 ...
 namespace Mosframe
{
    ...
    public abstract class DynamicScrollView : UIBehaviour
    {
        ...
        public TabletManager                    UI_Manager              ;// tablet LIST OF ROWS
        public int numeros;
        ...
        protected override void Start ()
	    {
            ...
            //       Debug.Log("num steps script" + UI_Manager.steps.Count);

            numeros = UI_Manager.num;
            Debug.Log("num steps script" + numeros);
            this._prevTotalItemCount = UI_Manager.num; //UI_Manager.steps.Count; //here
	    ...
	    private void Update()
	    {
            if (this.UI_Manager.num != this._prevTotalItemCount )
            {

                this._prevTotalItemCount = this.UI_Manager.num;
        ...
        private void refresh() {
            ...
            foreach( var itemRect in  this._containers )
            {
                ...
                this.updateItem( index, itemRect.gameObject ); //heere
	    ...
	    private void updateItem( int index, GameObject itemObj )
	    {
		    ...
		    else
            {
                ...
                if( item != null )
                {
                  //  item.SetDirection(UI_Manager.steps[index]);
                    item.onUpdateItem(index/*,UI_Manager.steps[index].GetDir()*/ ); // HEREEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
                }
